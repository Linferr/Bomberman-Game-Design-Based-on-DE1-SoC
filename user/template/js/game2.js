...
class SessionView {
    ...
    userStart() {
        Service.startSessions().then((result) => {
            ...
            (error) => {
                alert("Either session id is incorrect or the number of players does not meet the requirments");
                error;
            })
    }
...
class ControlView {
    constructor() {
        ...
        this.buttonElem_Bottom.addEventListener("click", () => {
            Service.playerMovement({direction: "Bottom"}).then(
                (result) => {
                    console.log(result);
                },
                (error) => {
        ...
        this.buttonElem_Top.addEventListener("click", () => {
            Service.playerMovement({direction: "Top"}).then(
                (result) => {
                    console.log(result);
                },
                (error) => {
